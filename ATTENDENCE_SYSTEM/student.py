...
class Student:
    def __init__(self, root):
       ...
       # image1
        img = Image.open(r"D:\DIP\Attendence_System\Images\12.jpeg")
        ...
        # image2
        img1 = Image.open(r"D:\DIP\Attendence_System\Images\13.jpg")
        ...
        # image3
        img2 = Image.open(r"D:\DIP\Attendence_System\Images\14.jpg")
        ...
        # backimg
        img3 = Image.open(r"D:\DIP\Attendence_System\Images\16.webp")
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="black", relief=RIDGE, text="Student Details", font=(
            "times new roman", 12, "bold"), cursor="hand2")
        ...
        # current Course
        current_course_frame = LabelFrame(Left_frame, bd=2, bg="black", relief=RIDGE, text="Current Course Infromation", font=(
        ...
        sem_combo["values"] = ("Select Semester",
                               "Semeter-1", "Semeter-2", "Semeter-3", "Semeter-4")
        sem_combo.current(0)
        sem_combo.grid(row=1, column=3, padx=2, pady=10, sticky=W)

        # Class Student Informatio
        class_student_frame = LabelFrame(Left_frame, bd=2, bg="black", relief=RIDGE, text="Class Student Infromation", font=(
            "times new roman", 12, "bold"))
        ...
        student_id_entry = ttk.Entry(class_student_frame, textvariable=self.var_std_id, width=20, font=(
            "times new roman", 13, "bold"))
        student_id_entry.grid(row=0, column=1, padx=10, pady=5, sticky=W)

        # student_name
        studentNamelabel = Label(class_student_frame, text="Student Name :", font=(
            "times new roman", 13, "bold"), bg="white")
        ...
        roll_no__entry = ttk.Entry(class_student_frame, textvariable=self.var_roll, width=20, font=(
            "times new roman", 13, "bold"))
        ...
        # DOB
        dob_label = Label(class_student_frame, text="DOD :", font=(
            "times new roman", 13, "bold"), bg="white")
        dob_label.grid(row=2, column=2, padx=10, pady=5, sticky=W)

        dob__entry = ttk.Entry(class_student_frame, textvariable=self.var_dob, width=20, font=(
            "times new roman", 13, "bold"))
        dob__entry.grid(row=2, column=3, padx=10, pady=5, sticky=W)
        ...
        email__entry = ttk.Entry(class_student_frame, textvariable=self.var_email, width=20, font=(
            "times new roman", 13, "bold"))
        ...
        phone__entry = ttk.Entry(class_student_frame, textvariable=self.var_phone, width=20, font=(
            "times new roman", 13, "bold"))
        ...
        address__entry = ttk.Entry(class_student_frame, textvariable=self.var_address, width=20, font=(
            "times new roman", 13, "bold"))
        address__entry.grid(row=4, column=1, padx=10, pady=5, sticky=W)
        ...
        teacher__entry = ttk.Entry(class_student_frame, textvariable=self.var_teacher, width=20, font=(
            "times new roman", 13, "bold"))
        teacher__entry.grid(row=4, column=3, padx=10, pady=5, sticky=W)
        ...
        take_photo_sample_btn = Button(btn_frame1, command=self.generate_dataset, text="Take Photo Sample", width=40, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
        take_photo_sample_btn.grid(row=0, column=0)

        update_photo_sample_btn = Button(btn_frame1, text="Update Photo Sample", width=40, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
        update_photo_sample_btn.grid(row=0, column=1)

        # Right lable frame

        Right_frame = LabelFrame(main_frame, bd=2, bg="black", relief=RIDGE, text="Student Details", font=(
            "times new roman", 12, "bold"), cursor="hand2")
        Right_frame.place(x=750, y=10, width=720, height=580)

        # image
        img_right = Image.open(r"D:\DIP\Attendence_System\Images\16.webp")
        ...
        # ***********************Search System**********************
        Search_frame = LabelFrame(Right_frame, bd=2, bg="black", relief=RIDGE, text="Serach System", font=(
            "times new roman", 12, "bold"))
        ...
        search__entry = ttk.Entry(Search_frame, width=15, font=(
            "times new roman", 13, "bold"))
        ...
        self.student_table.heading("sem", text="Semetser")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                ), self.var_std_name.get(), self.var_div.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get()))
                conn.commit()
                self.fetch_data()
                conn.close()
                messagebox.showinfo(
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(
                        host="localhost", username="root", password="Saurav@65", database="face_recog")
                    my_cursor = conn.cursor()
                    my_cursor.execute("update student set dep=%s,course=%s,year=%s,sem=%s,name=%s,division=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photosample=%s where std_id=%s", (self.var_dep.get(), self.var_course.get(), self.var_year.get(
                    ), self.var_semester.get(), self.var_std_name.get(), self.var_div.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get(), self.var_std_id.get()))
                else:
                    if not Update:
                        return
                messagebox.showinfo(
    ...
    # *************************Generate a dataSet to take a photo samples*************************************
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                ...
                for x in myresult:
                    id += 1
                my_cursor.execute("update student set dep=%s,course=%s,year=%s,sem=%s,name=%s,division=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photosample=%s where std_id=%s", (self.var_dep.get(), self.var_course.get(), self.var_year.get(
                ), self.var_semester.get(), self.var_std_name.get(), self.var_div.get(), self.var_roll.get(), self.var_gender.get(), self.var_dob.get(), self.var_email.get(), self.var_phone.get(), self.var_address.get(), self.var_teacher.get(), self.var_radio1.get(), self.var_std_id.get() == id+1))
                conn.commit()
                self.fetch_data()
                self.reset_data()
                conn.close()
