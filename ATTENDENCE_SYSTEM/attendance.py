...
class Attendance:
    def __init__(self, root):
        ...
        # image1
        img = Image.open(r"Images\12.jpeg")
        ...
        # image2
        img1 = Image.open(r"Images\13.jpg")
        ...
        # backimg
        img3 = Image.open(r"Images\16.webp")
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Attendence Details", font=(
            "times new roman", 12, "bold"), cursor="hand2")
        Left_frame.place(x=10, y=10, width=730, height=580)

        img_left = Image.open(r"Images\16.webp")
        ...
        # Attendence_id
        attendence_id_label = Label(left_inside_frame, text="Attendence ID :", font=(
            "times new roman", 13, "bold"), bg="white")
        attendence_id_label.grid(row=0, column=0, padx=10, pady=5, sticky=W)

        attendence_id_entry = ttk.Entry(left_inside_frame, textvariable=self.var_atten_id,  width=20, font=(
            "times new roman", 13, "bold"))
        attendence_id_entry.grid(row=0, column=1, padx=10, pady=5, sticky=W)

        # Attendence_Roll
        rollLabel = Label(left_inside_frame, text="Roll :", font=(
            "times new roman", 13, "bold"), bg="white")
        rollLabel.grid(row=0, column=2, padx=10, pady=5, sticky=W)

        atten_roll = ttk.Entry(left_inside_frame, textvariable=self.var_atten_roll,  width=20, font=(
            "times new roman", 13, "bold"))
       ...
       # Attendence_time
        ...
        import_btn = Button(btn_frame, command=self.importCsv, text="Import csv",  width=19, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
        import_btn.grid(row=0, column=0)

        export_btn = Button(btn_frame, command=self.exportCsv, text="Export csv", width=19, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln, mode="w", newline="") as myfile:
                ...
                messagebox.showinfo(
                    "Successfuly", "Export Data exported  to"+os.path.basename(fln)+"Successfully")
