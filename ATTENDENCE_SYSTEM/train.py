...
from turtle import bgcolor, color, right, title, width
...
class Train:
    def __init__(self, root):
        ...
        title_lbl = Label(self.root, text="Train DataSet", font=(
            "times new roman", 35, "bold"), bg="black", fg="red")
        ...
        img_bottom = Image.open(r"D:\DIP\Attendence_System\Images\16.webp")
